...
router.get('/:slug/media', async (req, res, next) => {
  try {
    ...
    // Demo media
    const demoMedia = [
      { id: 'm1', deal_id: DEMO_DEAL.id, type: 'photo', url: '/assets/deals/fairmont/hero.png', caption: 'Living area with modern finishes', category: 'interior', sort_order: 1 },
      { id: 'm2', deal_id: DEMO_DEAL.id, type: 'photo', url: '/assets/deals/fairmont/kitchen-living.png', caption: 'Open-concept kitchen and living area', category: 'interior', sort_order: 2 },
      { id: 'm3', deal_id: DEMO_DEAL.id, type: 'photo', url: '/assets/deals/fairmont/kitchen.png', caption: 'Chef-inspired kitchen with granite countertops', category: 'interior', sort_order: 3 },
      { id: 'm4', deal_id: DEMO_DEAL.id, type: 'photo', url: '/assets/deals/fairmont/bedroom.png', caption: 'Spacious primary bedroom', category: 'interior', sort_order: 4 },
      { id: 'm5', deal_id: DEMO_DEAL.id, type: 'photo', url: '/assets/deals/fairmont/bathroom.png', caption: 'Modern bathroom with premium finishes', category: 'interior', sort_order: 5 },
